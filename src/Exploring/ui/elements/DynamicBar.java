...
public class DynamicBar extends Bar {
    ...
    public DynamicBar(String name, Color color, Floatp fraction) {
    ...
    public DynamicBar(Prov<CharSequence> name, Prov<Color> color, Floatp fraction) {
        this.fraction = fraction;
    ...
    public void draw() {
        ...
        Draw.shader(ExShaders.dynamicBarShader);
