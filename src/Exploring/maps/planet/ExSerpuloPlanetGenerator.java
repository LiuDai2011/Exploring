...
public class ExSerpuloPlanetGenerator extends PlanetGenerator {
    ...
    protected void generate(){
        ...
        if(Simplex.noise3d(seed, 2, 0.5, scl, sector.tile.v.x, sector.tile.v.y, sector.tile.v.z)*nmag + poles > 0.19f*addscl){
            ores.add(ExBlocks.oreIron);
        }
        ...
        if(Simplex.noise3d(seed, 2, 0.5, scl, sector.tile.v.x + 1, sector.tile.v.y, sector.tile.v.z)*nmag + poles > 0.53f*addscl){
            ores.add(ExBlocks.oreSilicon);
        }
