...
public class ExRenderer {
    ...
    public static class BlackHoleRenderer {
        ...
        protected BlackHoleRenderer() {
            if (!Vars.headless) {
                ExShaders.BlackHoleShader.createShader();
        ...
        private void advancedDraw() {
            ...
            Draw.draw(Layer.max - 4f, () -> {
                ...
                if (holes.size >= ExShaders.BlackHoleShader.maxCount) ExShaders.BlackHoleShader.createShader();
                ...
                ExShaders.holeShader.blackHoles = blackholes;
                buffer.blit(ExShaders.holeShader);
