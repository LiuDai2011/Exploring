package annotations.src.main.java.mindustry.annotations.entity;
...
import annotations.src.main.java.mindustry.annotations.Annotations.*;
import annotations.src.main.java.mindustry.annotations.*;
import annotations.src.main.java.mindustry.annotations.util.*;
import annotations.src.main.java.mindustry.annotations.util.TypeIOResolver.*;
...
public class EntityProcess extends BaseProcessor{
    ...
    Seq<Builder> baseClasses = new Seq<>();
    ObjectSet<Builder> baseClassIndexers = new ObjectSet<>();
    ...
    public void process(RoundEnvironment env) throws Exception{
        ...
        if(round == 1){
            ...
            for(Stype component : allComponents){
                Builder inter = TypeSpec.interfaceBuilder(interfaceName(component))
                ...
                if(component.annotation(Component.class).base()){
                    ...
                    if(!component.has(EntityDef.class)){
                        Builder base = TypeSpec.classBuilder(baseName(component)).addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT);
            ...
            for(Selement<?> group : allGroups){
                ...
                Builder accessor = TypeSpec.interfaceBuilder("IndexableEntity__" + name);
            ...
            for(Selement<?> type : allDefs){
                ...
                @Nullable Builder baseClassBuilder = baseClassType == null ? null : this.baseClasses.find(b -> Reflect.<String>get(b, "name").equals(baseName(baseClassType)));
                ...
                Builder indexBuilder = baseClassBuilder == null ? builder : baseClassBuilder;
                ...
                if(!legacy){
                    Builder fieldBuilder = baseClassBuilder != null ? baseClassBuilder : builder;
            ...
            //generate groups
            Builder groupsBuilder = TypeSpec.classBuilder("Groups").addModifiers(Modifier.PUBLIC);
            ...
            Builder idBuilder = TypeSpec.classBuilder("EntityMapping").addModifiers(Modifier.PUBLIC)
            ...
            for(EntityDefinition def : definitions){
                ...
                for(Stype comp : def.components){
                    ...
                    @Nullable Builder superclass = null;
            ...
            for(Builder b : baseClasses){
                write(b, imports.toSeq());
            }

            //TODO nulls were an awful idea
            //store nulls
            Builder nullsBuilder = TypeSpec.classBuilder("Nulls").addModifiers(Modifier.PUBLIC).addModifiers(Modifier.FINAL);
            ...
            for(Stype interf : allInterfaces){
                ...
                Builder nullBuilder = TypeSpec.classBuilder(className)
    ...
    void skipDeprecated(Builder builder){
